...
if [ -f /www/server/panel/BTPanel/templates/default/soft.html ];then
    ...
    wget https://raw.kgithub.com/v2jun/bt-panel/master/bt_happy/src/soft.html
    chattr +i /www/server/panel/BTPanel/templates/default/soft.html
else
    cd /www/server/panel/BTPanel/templates/default
    wget https://raw.kgithub.com/v2jun/bt-panel/master/bt_happy/src/soft.html
...
if [ -f /www/server/panel/data/plugin.json ];then
    ...
    wget https://raw.kgithub.com/v2jun/bt-panel/master/bt_happy/src/plugin.json
    chattr +i /www/server/panel/data/plugin.json
else
    cd /www/server/panel/data
    wget https://raw.kgithub.com/v2jun/bt-panel/master/bt_happy/src/plugin.json
...
if [ -f /www/server/panel/BTPanel/templates/default/index.html ];then
    ...
    cd /www/server/panel/BTPanel/templates/default
    wget https://raw.kgithub.com/v2jun/bt-panel/master/bt_happy/src/index.html
else
    cd /www/server/panel/BTPanel/templates/default
    wget https://raw.kgithub.com/v2jun/bt-panel/master/bt_happy/src/index.html
fi
...
if [ -f /www/server/panel/task.py ];then
    ...
    cd /www/server/panel
    wget https://raw.kgithub.com/v2jun/bt-panel/master/bt_happy/src/task.py
    chattr +i /www/server/panel/task.py
else
    cd /www/server/panel
    wget https://raw.kgithub.com/v2jun/bt-panel/master/bt_happy/src/task.py
...
if [ -f /www/server/panel/data/repair.json ];then
    ...
    cd /www/server/panel/data
    wget https://raw.kgithub.com/v2jun/bt-panel/master/bt_happy/src/repair.json
    chattr +i /www/server/panel/data/repair.json
else
    cd /www/server/panel/data
    wget https://raw.kgithub.com/v2jun/bt-panel/master/bt_happy/src/repair.json
